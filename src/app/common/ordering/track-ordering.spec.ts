...
describe('TrackOrdering', () => {
    ...
    beforeEach(() => {
        ...
        track1.discNumber = 1;
        track1.albumKey = ';Album title 1;;Album artist 1;';
        ...
        track2.discNumber = 2;
        track2.albumKey = ';Album title 1;;Album artist 1;';
        ...
        track3.discNumber = 1;
        track3.albumKey = ';album title 3;;Album artist 2;';

        track4 = new Track('Path 4');
        track4.trackTitle = 'Title 4';
        track4.albumArtists = ';Album artist 2;';
        track4.albumTitle = 'Album title 2';
        track4.trackNumber = 1;
        track4.discNumber = 1;
        track4.albumKey = ';Album title 2;;Album artist 2;';

        track5 = new Track('Path 5');
        track5.trackTitle = 'Title 5';
        track5.albumArtists = ';Album artist 2;';
        track5.albumTitle = 'Album title 2';
        track5.trackNumber = 2;
        track5.discNumber = 1;
        track5.albumKey = ';Album title 2;;Album artist 2;';
        ...
        tracks = [trackModel2, trackModel4, trackModel1, trackModel5, trackModel3];
    ...
    describe('getTracksOrderedByTitleAscending', () => {
        it('should order tracks by title ascending', () => {
            ...
            expect(orderedTracks[4]).toBe(trackModel5);
        });
    });
    ...
    describe('getTracksOrderedByTitleDescending', () => {
        it('should order tracks by title descending', () => {
            ...
            // Assert
            expect(orderedTracks[0]).toBe(trackModel5);
            expect(orderedTracks[1]).toBe(trackModel4);
            expect(orderedTracks[2]).toBe(trackModel3);
            expect(orderedTracks[3]).toBe(trackModel2);
            expect(orderedTracks[4]).toBe(trackModel1);
        });
    });
    ...
    describe('getTracksOrderedByAlbum', () => {
        it('should order tracks by album', () => {
            ...
            expect(orderedTracks[3]).toBe(trackModel5);
            expect(orderedTracks[4]).toBe(trackModel3);
        });
    });
});
