...
describe('AlbumArtworkGetter', () => {
    ...
    describe('getAlbumArtwork', () => {
        it('should return external artwork when there is external artwork', async () => {
            // Arrange
        ...
        it('should return embedded artwork when there is no external artwork but there is embedded artwork', async () => {
            // Arrange
            const expectedAlbumArtwork = Buffer.from([1, 2, 3]);
            const metaDataMock: IMock<IFileMetadata> = Mock.ofType<IFileMetadata>();
        ...
        it('should return online artwork when settings require downloading missing covers when there is no external and no embedded artwork but there is online artwork and getOnlineArtwork is true', async () => {
            // Arrange
            const expectedAlbumArtwork = Buffer.from([1, 2, 3]);
            const metaDataMock: IMock<IFileMetadata> = Mock.ofType<IFileMetadata>();
        ...
        it('should return undefined when settings require downloading missing covers when there is no external and no embedded artwork but there is online artwork and getOnlineArtwork is false', async () => {
            // Arrange
            const expectedAlbumArtwork = Buffer.from([1, 2, 3]);
            const metaDataMock: IMock<IFileMetadata> = Mock.ofType<IFileMetadata>();
        ...
        it('should return undefined when settings do not require downloading missing covers when there is no external and no embedded artwork but there is online artwork and getOnlineArtwork is true', async () => {
            // Arrange
        ...
        it('should return undefined when settings do not require downloading missing covers when there is no external and no embedded artwork but there is online artwork and getOnlineArtwork is false', async () => {
            // Arrange
            const expectedAlbumArtwork = Buffer.from([1, 2, 3]);
            const metaDataMock: IMock<IFileMetadata> = Mock.ofType<IFileMetadata>();
        ...
        it('should return undefined when there is no external and no embedded and no online artwork', async () => {
            // Arrange
            const metaDataMock: IMock<IFileMetadata> = Mock.ofType<IFileMetadata>();
