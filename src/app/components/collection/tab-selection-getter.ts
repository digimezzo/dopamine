...
export class TabSelectionGetter {
    ...
    public getTabLabelForIndex(tabGroup: MatTabGroup, tabIndex: number): string {
        ...
        const selectedTab: MatTab = tabGroup._tabs.toArray().find((tab: MatTab) => tabGroup._tabs.toArray().indexOf(tab) === tabIndex);
    ...
    public getTabIndexForLabel(tabGroup: MatTabGroup, tabLabel: string): number {
        ...
        const selectedTab: MatTab = tabGroup._tabs.toArray().find((tab: MatTab) => tab.textLabel === tabLabel);
