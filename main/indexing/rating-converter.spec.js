...
describe('RatingConverter', () => {
    describe('starToPopMRating', () => {
        ...
        it('should return 0 when given 0.9', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.starToPopMRating(0.9);
    ...
    describe('popM2StarRating', () => {
        it('should return 0 when given -1', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(-1);
        ...
        it('should return 0 when given 0', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(0);
        ...
        it('should return 1 when given 0.9', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(0.9);
        ...
        it('should return 2 when given 2', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(2);
        ...
        it('should return 2 when given 63', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(63);
        ...
        it('should return 2 when given 64', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(64);
        ...
        it('should return 3 when given 65', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(65);
        ...
        it('should return 3 when given 127', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(127);
        ...
        it('should return 3 when given 128', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(128);
        ...
        it('should return 4 when given 129', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(129);
        ...
        it('should return 4 when given 195', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(195);
        ...
        it('should return 4 when given 196', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(196);
        ...
        it('should return 5 when given 197', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(197);
        ...
        it('should return 5 when given 254', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(254);
        ...
        it('should return 5 when given 255', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(255);
        ...
        it('should return 0 when given 256', () => {
            // Arrange
            // Act
            const popMRating = RatingConverter.popM2StarRating(256);
